        ...
        public static void FindItemsInSearchFolder()
        {
            ...
            //try
            {
                ...
                foreach (Folder folder in findResults.Folders)
                {
                    ...
                    if (folder.DisplayName.Equals("WCSE_SFMailboxSync"))
                    {
                        ...
                        do
                        {
                            ...
                            {
                                PropertySet pset = new PropertySet(BasePropertySet.IdOnly, ItemSchema.Subject, EmailMessageSchema.From, EmailMessageSchema.InternetMessageId, EmailMessageSchema.ToRecipients);
